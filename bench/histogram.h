// ported from raft-rsm/src/metrics/histogram.h — rigor infra, Raft-specifics stripped
#pragma once
...
namespace qe::metrics {

// HDR-style log-linear latency histogram: fixed storage, no allocation, O(1)
// record, mergeable across threads.
//
...
// value — ample resolution for the before/after relative comparisons this
// engine reports.
//
// Units are the caller's (this engine records nanoseconds). Range covers
...
// Renders the standard one-line latency summary used by the bench output.
